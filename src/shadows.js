...
const pointLightLightHelper = new THREE.CameraHelper(pointLight.shadow.camera);
pointLightLightHelper.visible = false;
...
gui.add(spotLight.shadow.camera, 'far').min(-10).max(10).step(0.01);
...
// shadow.rotation.y = plane.position.y + 0.01;
// scene.add(shadow);
/**
 * Sizes
 */
...
const tick = () => {
    ...
    // spotLight.position.x = Math.cos(elapsedTime * 2);
